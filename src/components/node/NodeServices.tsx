...
const NodeServices = ({ nodeId: propsNodeId }: NodeServicesProps = {}) => {
  ...
  const handleStartService = async (service: Service) => {
    ...
    try {
      // API 호출
      const response = await api.post(`/api/node/${nodeId}/service/${service.name}/start`);
  ...
  const handleStopService = async (service: Service) => {
    ...
    try {
      // API 호출
      const response = await api.post(`/api/node/${nodeId}/service/${service.name}/stop`);
  ...
  const handleRestartService = async (service: Service) => {
    ...
    try {
      // API 호출
      const response = await api.post(`/api/node/${nodeId}/service/${service.name}/restart`);
